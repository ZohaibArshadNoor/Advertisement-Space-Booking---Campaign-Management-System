      ...
      <div className="container" style={{ maxWidth: '460px', marginTop: '40px' }}>
        ...
        <div className="card-enterprise p-4 mb-4 shadow-md">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group-ui">
              <label className="form-label-ui" htmlFor="login-email">
                Work Email
              </label>
            ...
            <button
              type="submit"
              className="btn-ui btn-ui-primary w-100 py-2"
              disabled={loading}
            >
              {loading ? (
          ...
          <div className="border-top mt-4 pt-3">
            ...
            <div className="d-grid gap-1.5" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
              {DEMO_ACCOUNTS.map((demo) => (
                <button
                  key={demo.role}
                  type="button"
                  onClick={() => handleQuickFill(demo)}
                  className="btn-ui btn-ui-secondary btn-ui-sm text-start justify-content-start py-1.5 px-2"
        ...
        <div className="text-center">
          ...
          <small className="text-muted" style={{ fontSize: '0.7rem' }}>
            &copy; {new Date().getFullYear()} AdFlow Platform • End-to-End OOH Advertising System
          </small>
        </div>
      </div>
    </div>
